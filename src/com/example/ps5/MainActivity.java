...
public class MainActivity extends Activity implements OnItemSelectedListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		AnnualInvestment = (EditText) findViewById(R.id.textView1);
		InterestRate = (EditText) findViewById(R.id.textView1);
		FutureValue = (TextView) findViewById(R.id.textView1);
		...
		InterestRate.addTextChangedListener(
				        ...
				        Years = (Spinner) findViewById(R.id.action_settings);
